...
with open(legend_file, 'w') as f:
    f.write(f"""# GMT legend file
H 10p,black Legend
D 0.1c 1p
S 0.3c c {1*0.185}c white black 0.5c    Mw 1
S 0.3c c {2*0.185}c white black 0.5c    Mw 2
S 0.3c c {3*0.185}c white black 0.5c    Mw 3
S 0.3c c {4*0.185}c white black 0.5c    Mw 4
""")

# After all plotting, before fig.show() or fig.savefig()
fig.legend(
    spec=legend_file,
    position="jTR+w5c",
    box="+gwhite+p1p"
