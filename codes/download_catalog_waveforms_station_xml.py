...
def _mag_color(mag: float) -> str:
    """CSS color for a given magnitude (green → amber → orange → dark red)."""
    if   mag < 2.0: return '#43A047'   # green
    elif mag < 3.0: return '#FFB300'   # amber
    elif mag < 4.0: return '#E64A19'   # deep orange
...
def _build_folium_map(cat: Catalog, inv, cfg: dict):
    ...
    <div style="
      ...
      <b>Legend</b><br>
      <span style="color:#43A047; font-size:16px">●</span>&nbsp; M &lt; 2.0<br>
      <span style="color:#FFB300; font-size:16px">●</span>&nbsp; 2.0 ≤ M &lt; 3.0<br>
      <span style="color:#E64A19; font-size:16px">●</span>&nbsp; 3.0 ≤ M &lt; 4.0<br>
      <span style="color:#B71C1C; font-size:16px">●</span>&nbsp; M ≥ 4.0<br>
      <span style="color:#1565C0; font-size:16px">▲</span>&nbsp; Station
    </div>"""
